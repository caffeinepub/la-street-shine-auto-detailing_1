              ...
              <form onSubmit={handleSubmit} noValidate className="p-6 md:p-8 rounded-xl glass-card space-y-5">
                ...
                {isError && (
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-brand-pink/10 border border-brand-pink/30">
                    <AlertCircle className="w-5 h-5 text-brand-pink-light flex-shrink-0 mt-0.5" />
                    <div>
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="btn-blue w-full py-4 rounded text-base font-black flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isPending ? (
                    <>
