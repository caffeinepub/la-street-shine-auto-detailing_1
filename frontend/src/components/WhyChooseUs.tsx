          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-2xl bg-brand-blue/20 flex items-center justify-center flex-shrink-0 group-hover:bg-brand-blue/30 transition-colors">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-2xl bg-brand-pink/20 flex items-center justify-center flex-shrink-0 group-hover:bg-brand-pink/30 transition-colors">
