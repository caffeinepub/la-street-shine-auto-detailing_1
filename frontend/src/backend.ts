...
export class Backend implements backendInterface {
    ...
    async getBookingsByStatus(arg0: BookingStatus): Promise<Array<Booking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingsByStatus(to_candid_BookingStatus_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitBooking(arg0: BookingInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBooking(to_candid_BookingInput_n15(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateServiceInfo(arg0: ServiceInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateServiceInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "interiorOnly" in value ? ServiceType.interiorOnly : "exteriorOnly" in value ? ServiceType.exteriorOnly : "premiumDetail" in value ? ServiceType.premiumDetail : "motorcycleDetail" in value ? ServiceType.motorcycleDetail : "standardDetail" in value ? ServiceType.standardDetail : "rvWash" in value ? ServiceType.rvWash : "ceramicCoating" in value ? ServiceType.ceramicCoating : value;
}
...
function to_candid_BookingInput_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BookingInput): _BookingInput {
...
function to_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.interiorOnly ? {
        interiorOnly: null
    } : value == ServiceType.exteriorOnly ? {
        exteriorOnly: null
    } : value == ServiceType.premiumDetail ? {
        premiumDetail: null
    } : value == ServiceType.motorcycleDetail ? {
        motorcycleDetail: null
    } : value == ServiceType.standardDetail ? {
        standardDetail: null
    } : value == ServiceType.rvWash ? {
        rvWash: null
