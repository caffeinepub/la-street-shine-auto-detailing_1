          ...
          <form onSubmit={handleLogin} className="p-8 rounded-xl glass-card space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full bg-brand-black/60 border border-brand-blue/20 rounded-lg px-4 py-3 text-white placeholder:text-brand-gray/50 text-sm focus:outline-none focus:border-brand-blue/60 transition-colors"
              />
            </div>
      ...
      <form onSubmit={handleSave} className="p-6 rounded-xl glass-card space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-brand-black/60 border border-brand-blue/20 rounded-lg px-4 py-3 text-white placeholder:text-brand-gray/50 text-sm focus:outline-none focus:border-brand-blue/60 transition-colors resize-none"
          />
        </div>
