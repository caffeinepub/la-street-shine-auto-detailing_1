                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-brand-blue/20 border border-brand-blue/40 mb-2">
                      <span className="text-brand-blue-light text-xs font-black tracking-wider uppercase">
                        Referral Reward
                      </span>
                    </div>
                    <div className="text-4xl font-black text-brand-blue-light leading-none mb-1">
                      40% OFF
                    </div>
                    <p className="text-brand-gray text-sm leading-relaxed">
                      Refer a new client to us and receive{" "}
                      <span className="text-white font-semibold">40% off</span>{" "}
                      your next service. Share the shine, earn the savings!
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-brand-pink/20 border border-brand-pink/40 mb-2">
                      <span className="text-brand-pink-light text-xs font-black tracking-wider uppercase">
                        Loyalty Discount
                      </span>
                    </div>
                    <div className="text-4xl font-black text-brand-pink-light leading-none mb-1">
                      15% OFF
                    </div>
                    <p className="text-brand-gray text-sm leading-relaxed">
                      Returning for your second visit? Enjoy{" "}
                      <span className="text-white font-semibold">15% off</span>{" "}
                      your service. Loyalty has its rewards!
                    </p>
                  </div>
                </div>
              </div>
